...
/obj/random/trash/site53 //Mostly remains and cleanable decals. Stuff a janitor could clean up
	name = "random trash"
	desc = "This is some random trash."
	icon = 'icons/effects/effects.dmi'
	icon_state = "greenglow"

/obj/random/trash/site53/spawn_choices()
	return list(
...
/obj/random/masks/site53
	name = "random mask"
	desc = "This is a random face mask."
	icon = 'icons/obj/clothing/masks.dmi'
	icon_state = "gas_mask"

/obj/random/masks/site53/spawn_choices()
...
/obj/random/snack/site53
	name = "random snack"
	desc = "This is a random snack item."
	icon = 'icons/obj/food.dmi'
	icon_state = "sosjerky"

/obj/random/snack/site53/spawn_choices()
...
/obj/random/glasses/site53
	name = "random eyewear"
	desc = "This is a random pair of glasses."
	icon = 'icons/obj/clothing/glasses.dmi'
	icon_state = "leforge"

/obj/random/glasses/site53/spawn_choices()
...
/obj/random/suit/site53
	name = "random suit"
	desc = "This is a random piece of outerwear."
	icon = 'icons/obj/clothing/suits.dmi'
	icon_state = "fire"

/obj/random/suit/site53/spawn_choices()
...
/obj/random/clothing/site53
	name = "random clothes"
	desc = "This is a random piece of clothing."
	icon = 'icons/obj/clothing/uniforms.dmi'
	icon_state = "grey"

/obj/random/clothing/site53/spawn_choices()
...
/obj/random/maintenance/site53 //Clutter and loot for maintenance and away missions
	name = "random maintenance item"
	desc = "This is a random maintenance item."
	icon = 'icons/obj/items.dmi'
	icon_state = "gift1"

/obj/random/maintenance/site53/spawn_choices()
	return list(/obj/random/junk = 4,
				/obj/random/trash/site53 = 4,
				/obj/random/maintenance/site53/clean = 5)

/obj/random/maintenance/site53/clean
...
/obj/random/maintenance/site53/clean/spawn_choices()
	return list(/obj/random/tech_supply = 100,
				...
				/obj/random/shoes/site53 = 20,
				/obj/random/gloves = 10,
				/obj/random/glasses/site53 = 20,
				/obj/random/hat/site53 = 10,
				/obj/random/suit/site53 = 20,
				/obj/random/clothing/site53 = 30,
